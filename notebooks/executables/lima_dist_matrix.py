...
pop_lima = up.download.download_hdx("4e74db39-87f1-4383-9255-eaf8ebceb0c9/resource/317f1c39-8417-4bde-a076-99bd37feefce/download/population_per_2018-10-01.csv.zip")
...
minx, miny, maxx, maxy = hex_lima_.bounds['minx'].min(), hex_lima_.bounds['miny'].min(), hex_lima_.bounds['maxx'].max(), hex_lima_.bounds['maxy'].max()
