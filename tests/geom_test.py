...
class GeomTest(unittest.TestCase):
    ...
    def test_filter_population(self):
        ...
        * Filter population data within the city limits
        ...
        # Test path length
        self.assertEqual(
            filtered_points_gdf.shape,
            filtered_points_gdf.cx[minx:maxx, miny:maxy].shape,
        )
    ...
    def test_merge_shape_hex(self):
        ...
        * Merge data
        ...
        merged_hex = up.geom.merge_shape_hex(
            hex_gdf, filtered_points_gdf, agg={"bol_general_2020": "sum"}
        )
        ...
        spatial_filter = filtered_points_gdf.geometry.intersects(
            hex_gdf.geometry.unary_union
        )
        population_points_sum = filtered_points_gdf[spatial_filter][
            "bol_general_2020"
        ].sum()
    ...
    def test_resolution_downsampling(self):
        ...
        * Merge data
        ...
        # Downsample data
        hex_downsampled = up.geom.resolution_downsampling(
            merged_hex, "hex", 5, {"bol_general_2020": "sum"}
        )
