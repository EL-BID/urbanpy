...
class UtilTest(unittest.TestCase):
    def test_xy_swap(self):
        ...
        self.assertEqual(
            list(swapped_poly.exterior.coords),
    ...
    def test_nn_search(self):
        ...
        * Test empty series
        ...
        self.assertEqual(
            dist.all(),
            np.array(
                [[111.19492664], [114.18057105], [157.24938127], [8850.65659794]]
            ).all(),
        )
        ...
        self.assertEqual(
            dist.all(), np.array([[1.0], [1.41421356], [1.41421356], [155.0]]).all()
        )
    ...
    def test_shell_from_geometry(self):
        ...
        self.assertEqual(
            up.utils.shell_from_geometry(inp),
            [
    ...
    def test_duration_labels(self):
        ...
        * Test from 10-100
        ...
        inp_3 = np.array(
            [38.78371215, 91.68736876, 51.42509596, 35.00861296, 52.06796523]
        )
